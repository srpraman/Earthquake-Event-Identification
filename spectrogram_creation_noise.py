...
file_list = os.listdir("/home/sairaman/Desktop/trial_folder/2015096040542")
...
def spec_plot(file_list):
    ...
    for file_name in file_list:
        try:   
            st = obspy.read("/home/sairaman/Desktop/trial_folder/2015096040542/" + file_name)
            st.detrend("linear")
            #st.filter('bandpass', freqmin=2, freqmax=10, corners=4, zerophase=True)
            st.spectrogram(log=True,outfile="/home/sairaman/Desktop/trial_folder/" + file_name +'.jpeg',fmt='jpeg',show=False)
            plt.plot()
            plt.close() 
